# 3D Modelling Project - Will's Memorial Building Geology Library

This is a 3D model of the geology library in Will’s Memorial Building, Bristol, which I created this over the course of several months for the Character and Set Design university module. I did a majority of the modelling work from within in the library itself; the lighting, texturing, and the remainder of the modelling were done from home using a series of reference photos.

![Completed render of the library model](/TexturingAndLightingRender.jpeg)

The model itself was too large to include in this repository: I have included the final render 'TexturingAndLightingRender.jpg', alongside a series of images of the completed model.
